...
<!-- body_text //-->
	...
	die('<div id="lrerror">Please add following code in file YOUR_ADMIN/includes/filenames.php<br><br>define(\'FILENAME_SOCIALLOGINANDSOCIALSHARE\', \'socialloginandsocialshare.php\');</div>');
	} 
	elseif(!defined('TABLE_LOGINRADIUS_SETTING') || !defined('BOX_MODULES_SOCIAL_LOGIN')) {
		die('<div id="lrerror">Please add following code in file YOUR_ADMIN/includes/database_tables.php<br><br>define(\'TABLE_LOGINRADIUS_SETTING\', \'loginradius_setting\');</div>');
		}
...
<tr>
<td colspan="2"><span class="pageHeading"><?php echo 'Social Login and Social Share Modules';?></span><p align="right" style="margin:0;"><?php echo 'version 2.0';?></p>
</td></tr>
  <tr>
    <td>
	 ...
	 <fieldset class="sociallogin_form sociallogin_form_main" style="background:#EAF7FF; border: 1px solid #B3E2FF;font-family: sans-serif;">
      ...
      <h3 style="border-bottom:#000000 1px solid; margin:0px; padding:0 0 6px 0; border-bottom: 1px solid #B3E2FF; color: #000000; margin:10px;"><?php echo 'Thank you for installing the LoginRadius OsCommerce Module version 2.2!';?></h3>
     
      <div class="sociallogin_row" style="width:90%; line-height:160%;">
        <?php echo 'To activate the extension, please configure it and manage the social networks from you LoginRadius account. If you do not have an account, click <a href="http://www.loginradius.com" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">here</span></a> and create one for FREE! '; ?> 
      </div>
      <div class="sociallogin_row" style="width:90%; line-height:160%;">
        <?php echo 'We also have Social Plugin for <a href="https://www.loginradius.com/loginradius-cms-social-plugins/wordpress-plugin" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">WordPress</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/drupal-module" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">Drupal</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/vbulletin-forum-add-on" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">vBulletin</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/vanilla-forum-add-on" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">VanillaForum</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/magento-extension" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">Magento</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/oscommerce-addon" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">osCommerce</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/prestashop-module" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">PrestaShop</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/x-cart-module" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">X-Cart</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/zencart-plugin" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">Zen-Cart</span></a>, <a href="https://www.loginradius.com/loginradius-cms-social-plugins/dotnetnuke-module" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">DotNetNuke</span></a> and <a href="https://www.loginradius.com/loginradius-cms-social-plugins/blogengine-extension" target="_blank"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">BlogEngine</span></a>!'; ?> 
      </div>
...
<dl id="pane" class="tabs">
	<dt class="panel1 open" id="panel1"  style="cursor:pointer;font-family: sans-serif;font-weight: bold;" ><span onclick=javascript:panelshow("first")><?php echo 'Social Login'; ?></span></dt>
	<dt class="panel2 closed" id="panel2" style="cursor:pointer;font-family: sans-serif;font-weight: bold;" ><span onclick=javascript:panelshow("second")><?php echo 'Social Share'; ?></span></dt>
	<dt class="panel3 closed" id="panel3" style="cursor:pointer;font-family: sans-serif;font-weight: bold;" ><span onclick=javascript:panelshow("third")><?php echo 'Social Counter'; ?></span></dt>
	</dl>
	<div class="current">
...
<td class="head">Social Login API Setting</small></td>
  ...
  <tr>
	...
	?>
	<input id="connection_url" type="hidden" value="<?php $adminurl;?>" />
...
<td class="sociallogin_row_white">What API Connection Method do you prefer to enable API communication?<br><br>
	...
	<table><tr><td><div class="sociallogin_row sociallogin_row_button btn btn-small " style="margin-top:0px !important;">
						<div class="button2-left">
							<div class="blank">
		<a href="javascript:void(0);" onClick="MakeRequest();"><?php echo 'Verify API Settings'; ?></a>
							</div>
						</div>
					</div></td><td><div id="ajaxDiv"></div></td></tr></table>
  </tr>
</table>
<table class="form-table sociallogin_table">
  <tr>
...
<table class="form-table sociallogin_table">
  ...
  <tr>
  <td>Do you want to enable Social Login on Sidebox for your website?<br><br>
  <?php
  		$enablesidebox='';
		$disablesidebox='';
		$socialsidebox = (isset($lrsetting['socialsidebox'])  ? $lrsetting['socialsidebox'] : "");
		if ($socialsidebox == '0') $disablesidebox = "checked='checked'";
		else $enablesidebox = "checked='checked'";
  ?>
  <input name="lrsetting[socialsidebox]" type="radio" value="1" <?php echo $enablesidebox;?>/>Yes
	&nbsp;&nbsp;
    <input name="lrsetting[socialsidebox]" type="radio" value="0" <?php echo $disablesidebox;?>/>No
  </td>
  </tr>
  <tr>
  <td class="sociallogin_row_white">Select the position of Social Login interface <br><br>
  <?php
  		$leftinterface='';
		$rightinterface='';
		$socialinterface = (isset($lrsetting['socialinterface'])  ? $lrsetting['socialinterface'] : "");
		if ($socialinterface == '0') $leftinterface = "checked='checked'";
		else $rightinterface = "checked='checked'";
  ?>
  <input name="lrsetting[socialinterface]" type="radio" value="0" <?php echo $leftinterface;?>/>Left SideBox
	&nbsp;&nbsp;
    <input name="lrsetting[socialinterface]" type="radio" value="1" <?php echo $rightinterface;?>/>Right SideBox
  </td>
  </tr>
  <tr>
	...
	<?php  
			...
			else $showfullname = "checked='checked'";?>
...
$hori32 = "";
		 ...
		 <?php echo 'Copy and paste the code provided below at the required pages to show the selected interface. (Follow the steps provided in the <a target="_blank" href="http://support.loginradius.com/customer/portal/articles/1091378-oscommerce-social-login-installation-configuration-and-troubleshooting#support"><span style="color:#3CF;">support document</span></a>)';?>
         <br> <br>
         <div onClick="select_all(this)" style="background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #C5F0FB;color: #000000;font-family: Arial,Helvetica,sans-serif;font-size: 12px;padding: 2px;width: 437px;">
         <?php echo '&lt;?php echo $socialshare; ?&gt;';?></div>
         </div></div>
         ...
         <table width="100%"  style="overflow:auto; background:#EBEBEB; padding:10px;"><tr><td>
        ...
        <input name="lrsetting[choosesharepos]" id = "bottomshareright" type="radio" <?php echo $bottomshareright;?>value="3" style="margin:0;"/> <?php echo 'Bottom Right'; ?> <br /></td></tr><tr><td style="margin:0 0 6px 0; padding:0px;"><strong><?php echo 'Specify distance of vertical sharing interface from top. (Leave empty for default behaviour)';?><a title="<?php echo 'Enter a number (For example - 200). It will set the \'top\' CSS attribute of the interface to the value specified. Increase in the number pushes interface towards bottom.';?>" href="javascript:void(0)" style="text-decoration:none"> (<span style="color:#3CF;">?</span>)</a></strong><br>
	  <input size="30" type="text" name="lrsetting[verticalsharetopoffset]" id="verticalsharetopoffset" value="<?php echo (isset ($lrsetting['verticalsharetopoffset']) ? htmlspecialchars ($lrsetting['verticalsharetopoffset']) : ''); ?>" /><br><br>
      </td></tr><tr><td><strong>What area's do you want to show the social Share widget?</strong><br><br>
	<?php
  ...
  <tr>
	...
	<ul onMouseOver="lr_sortable();" id="sortable" class="ui-sortable" style="float:left; margin-left:0px;">
						<?php 
						if (empty($rearrange)) {
						  $rearrange[] = 'facebook';
...
<table class="form-table sociallogin_table">
  ...
  <tr>
    <td>
    What Social Counter widget theme do you want to use across your website?
<br><br>
<?php 		$chori32 = "";
	        $chori16 = "";
			$cvertibox32 = "";
	 ...
	 <?php echo 'Copy and paste the code provided below at the required pages to show the selected interface. (Follow the steps provided in the <a target="_blank" href="http://support.loginradius.com/customer/portal/articles/1091378-oscommerce-social-login-installation-configuration-and-troubleshooting#support"><span style="color:#3CF;">support document</span></a>)';?>
         <br> <br>
         <div onClick="select_all(this)" style="background: none repeat scroll 0 0 #FFFFFF;border: 1px solid #C5F0FB;color: #000000;font-family: Arial,Helvetica,sans-serif;font-size: 12px;padding: 2px;width: 437px;">
         <?php echo '&lt;?php echo $socialcounter; ?&gt;';?>
      </div></div></div>
      ...
      <input name="lrsetting[choosecounter]" id = "cvertibox16" type="radio" <?php echo $cvertibox16;?> value="3" style="vertical-align:top"/> <img src = '<?php echo "socialloginandsocialshare/images/socialcounter/hybrid-verticle-vertical.png"?>' /><table width="100%" style="overflow:auto; background:#EBEBEB; padding:10px;"><tr>
    <td>      
        ...
        <input name="lrsetting[choosecounterpos]" id = "bottomcounterright" type="radio" <?php echo $bottomcounterright;?>value="3" style="margin:0;"/> <?php echo 'Bottom Right'; ?> <br /></td></tr><tr><td>
	 ...
	 <input size="30" type="text" name="lrsetting[verticalcountertopoffset]" id="verticalcountertopoffset" value="<?php echo (isset($lrsetting['verticalcountertopoffset']) ? htmlspecialchars ($lrsetting['verticalcountertopoffset']) : ''); ?>" /><br><br></p>
         <p style="margin:0 0 6px 0; padding:0px;"></td></tr><tr><td>
     <strong>What area's do you want to show the social counter widget?</strong><br><br>
	<?php
		...
		<input name="lrsetting[countershoppingpages]"  type="checkbox"  <?php echo $countershoppingpages;?> value="on"  /> <?php echo 'Shopping Cart'; ?></p></td>
  </tr></table>
  </div>
	  </td>
  </tr>
...
<center>
<button type="submit" value="save" style="padding:2px 20px;">Save Settings</button>
</td>
</center></div></td>
...
<?php echo 'If you liked our FREE open-source plugin, please send your feedback/testimonial to <a href="mailto:feedback@loginradius.com"><span style="color: #0088CC;font-family: sans-serif; font-size: 12px;">feedback@loginradius.com</span></a>! '; ?> <br>
</div>
 </div>
</td>
  </tr>
